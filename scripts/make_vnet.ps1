...
New-NetIPAddress -IPAddress 192.168.0.1 -PrefixLength 24 -InterfaceIndex $IF_INDEX
...
New-NetNat -Name "internal_vNAT" -InternalIPInterfaceAddressPrefix 192.168.0.0/24
